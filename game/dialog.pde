...
public void initializeDialogs() {
    dialogFont = loadFont("Calibri-48.vlw");
}
...
class BeginBlockDialog extends Dialog {
    String lines[];
    ...
    void setText() {
        if (this.displayTakeABreakText) {
            ...
            lines[1] = "When you're ready, stand at the workspace with your name.";
            lines[2] = "Then, tap and hold the OK button.";
        } else {
            lines[0] = "Stand at the workspace with your name.";
            lines[1] = "";
            lines[2] = "When you're ready, tap and hold the OK button.";
        }
    }
